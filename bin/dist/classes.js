const tinyFy = require("./tinyfyRegex")
...
const staticUtility = new RegExp(`${display}|${justifyContentAndSelf}|${alignItemsAndSelf}|${alignContents}|${float}|${flexDirection}|${flexWrapShrinkGrow}|${position}|${cursor}|${listStyle}|${textDecoration}`, "i")
